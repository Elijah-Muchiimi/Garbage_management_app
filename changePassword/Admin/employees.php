		...
		<form action="action.php" method="POST">
				<input type="hidden" name="user" value="<?php echo $_SESSION['name']; ?>">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="fname" name="fname" placeholder="Paul:" required>
				 </div>
				 <div class="form-group">
					<label for="exampleFormControlInput1">SurName:</label>
					<input type="text" class="form-control" id="surname" name="surname" placeholder="Kanyora:" required>
				 </div>
				 <div class="form-group">
					<label for="exampleFormControlInput1">Phone:</label>
					<input type="text" class="form-control" id="phone" name="phone" placeholder="+254712345678" required>
				 </div>
				 <div class="form-group">
